const DatabaseManager = {
    ...
    insertData() {
        ...
        // === EVIDENCE (20 items, including 3 red herrings) ===
        this.db.run(`
        ...
        this.db.run(`
            ...
            (5, 2, 4, '2024-03-12 14:00', '电话', 20, '讨论保险理赔条件和金额'),
        ...
        this.db.run(`
            ...
            (9, 13, 2, '2024-03-18 19:00', '2024-03-18 22:30', '码头区工棚', NULL, 0),
